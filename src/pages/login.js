  ...
  return (
    <div className="loginPage">
      <Grid container className={classes.gridContainer}>
        <Hidden mdDown>
          <Grid item lg={6} className={classes.imageContainer} sx={{marginLeft:'10%'}}>
            <img
              src="./img/Tablet login.gif"
              alt="Image"
            ...
            >
              <form onSubmit={handleSubmit}>
                <Stack direction="column">
                  ...
                  <Typography
                    variant="body1"
                    sx={{ textAlign: "center", marginTop: 2, color: "#0D1B2A" }}
                  >
                    Not registered?{" "}
                    <Link
                      href="/signin"
